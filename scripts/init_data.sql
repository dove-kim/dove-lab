...
INSERT IGNORE INTO CREDENTIAL (MEMBER_ID, USERNAME, PASSWORD_HASH, FAILED_ATTEMPTS, PASSWORD_RESET_REQUIRED)
SELECT ID, 'admin', '$2a$10$ozV6pKNkhik1CIzh24.LoeKFxUcePT0wkTzJeh9dKKMsx544dUxq2', 0, 0
FROM MEMBER WHERE EMAIL = 'admin@dove.local';

INSERT IGNORE INTO CREDENTIAL (MEMBER_ID, USERNAME, PASSWORD_HASH, FAILED_ATTEMPTS, PASSWORD_RESET_REQUIRED)
SELECT ID, 'manager', '$2a$10$ozV6pKNkhik1CIzh24.LoeKFxUcePT0wkTzJeh9dKKMsx544dUxq2', 0, 0
FROM MEMBER WHERE EMAIL = 'manager@dove.local';

INSERT IGNORE INTO CREDENTIAL (MEMBER_ID, USERNAME, PASSWORD_HASH, FAILED_ATTEMPTS, PASSWORD_RESET_REQUIRED)
SELECT ID, 'alice', '$2a$10$ozV6pKNkhik1CIzh24.LoeKFxUcePT0wkTzJeh9dKKMsx544dUxq2', 0, 0
FROM MEMBER WHERE EMAIL = 'alice@dove.local';

INSERT IGNORE INTO CREDENTIAL (MEMBER_ID, USERNAME, PASSWORD_HASH, FAILED_ATTEMPTS, PASSWORD_RESET_REQUIRED)
SELECT ID, 'bob', '$2a$10$ozV6pKNkhik1CIzh24.LoeKFxUcePT0wkTzJeh9dKKMsx544dUxq2', 0, 0
FROM MEMBER WHERE EMAIL = 'bob@dove.local';

INSERT IGNORE INTO CREDENTIAL (MEMBER_ID, USERNAME, PASSWORD_HASH, FAILED_ATTEMPTS, PASSWORD_RESET_REQUIRED)
SELECT ID, 'charlie', '$2a$10$ozV6pKNkhik1CIzh24.LoeKFxUcePT0wkTzJeh9dKKMsx544dUxq2', 0, 0
