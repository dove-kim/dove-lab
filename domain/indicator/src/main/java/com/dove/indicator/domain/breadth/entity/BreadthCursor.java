...
/**
 * (universe, 가격유형) 단위로 당일 상승비율 계산이 완료된 마지막 거래일을 추적하는 날짜축 커서.
 */
@Getter
@Entity
@Table(name = "BREADTH_CURSOR",
        uniqueConstraints = @UniqueConstraint(
                name = "UK_BC_UNIVERSE_PRICETYPE",
                columnNames = {"UNIVERSE", "PRICE_TYPE"}))
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class BreadthCursor {
    ...
    @Comment("상승비율 계산이 완료된 마지막 거래일. NULL이면 처음부터 계산")
    ...
    public BreadthCursor(MarketUniverse universe, PriceType priceType) {
