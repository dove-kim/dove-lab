...
@Entity
@Table(
    name = "MEMBER_SUB_MENU_GRANT",
    uniqueConstraints = @UniqueConstraint(
        name = "UK_MEMBER_SUB_MENU_GRANT",
        columnNames = {"MEMBER_ID", "SUB_MENU_CODE"}
    ),
    indexes = @Index(name = "IDX_MEMBER_SUB_MENU_GRANT_MEMBER_ID", columnList = "MEMBER_ID")
)
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class MemberSubMenuGrant {
    ...
    public static MemberSubMenuGrant create(Long memberId, SubMenuCode subMenuCode, Long grantedBy) {
        MemberSubMenuGrant g = new MemberSubMenuGrant();
        g.memberId = memberId;
